...
export default function CierreOrdenInspeccion() {
  ...
  useEffect(() => {
    // Simular carga de órdenes completadas
    const ordenesSimuladas: OrdenInspeccion[] = [
      {
        id: "1",
        numero: "ORD-2024-001",
    ...
    const motivosSimulados: MotivoTipo[] = [
      {
        id: "1",
        nombre: "Inspección satisfactoria",
        descripcion: "La inspección se completó sin observaciones críticas",
      },
      {
        id: "2",
        nombre: "Observaciones menores",
        descripcion: "Se encontraron observaciones menores que no afectan la operación",
      },
      {
        id: "3",
        nombre: "Recomendaciones de mejora",
        descripcion: "Se identificaron oportunidades de mejora",
      },
      {
        id: "4",
        nombre: "Seguimiento requerido",
        descripcion: "Se requiere seguimiento posterior",
      },
      {
        id: "5",
        nombre: "Documentación adicional",
        descripcion: "Se necesita documentación complementaria",
      },
    ]
                  ...
                  <div className="p-4 bg-muted rounded-lg space-y-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          <strong>Fecha:</strong> {ordenSeleccionada.fechaCreacion}
                        </span>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
